  ...
  render() {
    const customMessageElement = (
      ...
      <div className='about-page' >
        ...
        <span>
        <h3 className="about-page-item" style={{ textAlign:'left', fontFamily:'Sarpanch', fontWeight:'300', letterSpacing:'4px', padding:'2em'}}>
          RICHARD SCHEIWE
        </h3>
        <p className="about-page-item2" style={{fontFamily:'Roboto Condensed', fontWeight:'300', textAlign:'left', padding:'2em'}}>
